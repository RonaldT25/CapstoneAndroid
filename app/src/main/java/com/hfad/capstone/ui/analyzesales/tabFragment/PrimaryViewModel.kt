...
@HiltViewModel
class PrimaryViewModel @Inject constructor(private val repository: ResponseSalesRepository) : ViewModel() {

    fun getAnalyzeSales(id:Int): LiveData<Resource<ResponseSalesEntity>> {
